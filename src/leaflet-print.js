...
!function (t, e) {
    ...
    var e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof window.self ? window.self : {},
        n = t(function (t) {
            !function (e) {
                function n(t, e) {
                    function n(t) {
                ...
                var h = function () {
                    ...
                    function l(t) {
                        var e = 3e4;
                        return w.impl.options.cacheBust && (t += (/\?/.test(t) ? "&" : "?") + (new Date).getTime()), new Promise(async function (n) {
                            function i() {
                                if (4 === a.readyState) {
                            ...
                            //             var t = e.result.split(/,/)[1];
                            //             n(t)
                            //         }, e.readAsDataURL(checke.response)
                            //
                            // }
                            ...
                            a.onreadystatechange = i, a.ontimeout = o, a.responseType = "blob", a.timeout = e, a.open("GET", t,!0),
                                //a.setRequestHeader("Access-Control-Allow-Headers", "access-control-allow-method,access-control-allow-origin"),
                                //a.setRequestHeader("Access-Control-Allow-Methods", "POST, GET, OPTIONS, PUT, DELETE"),
                                a.setRequestHeader("Access-Control-Allow-Origin", "*/*"),
                                //a.setRequestHeader("Access-Control-Max-Age", "500"),
                                //.setRequestHeader("Allow", "POST, GET, OPTIONS, PUT, DELETE"),
                                a.send();


                            // console.log("FA "+a.response);
                            // var checke = await fetch(t, {
                            //     crossDomain: true
                            // })
                ...
                }(), M = {imagePlaceholder: void 0, cacheBust: !1}, w = {
                    toSvg: n,
                    toPng: o,
                    toJpeg: r,
                    toBlob: a,
            ...
            }("undefined" != typeof window.self && window.self || "undefined" != typeof window && window || e.content);
    ...
    L.Control.EasyPrint = L.Control.extend({
        options: {
            ...
            return t
             ...
             spinner.spin(document.getElementById('root'));
            ...
            }, "auto" === this.originalState.mapWidth ? (this.originalState.mapWidth = this._map.getSize().x + "px", this.originalState.widthWasAuto = !0) : this.originalState.mapWidth.includes("%") && (this.originalState.percentageWidth = this.originalState.mapWidth, this.originalState.widthWasPercentage = !0, this.originalState.mapWidth = this._map.getSize().x + "px"), this._map.fire("easyPrint-start", {event: t}), this.options.hidden || this._togglePageSizeButtons({type: null}), this.options.hideControlContainer &&  (this._toggleControlsSidebarLeft() , this._toggleControlsSidebarRight() , this._toggleControls(),this._toggleControlsTopLeft());
            ...
            var e = document.getElementsByClassName("leaflet-top leaflet-right")[0];
            if (t) return e.style.display = "block";
            e.style.display = "none"

        },
        _toggleControlsTopLeft: function (t) {
            var e = document.getElementsByClassName("leaflet-top leaflet-left")[0];
            if (t) return e.style.display = "block";
            e.style.display = "none"

        },
        _toggleControlsSidebarLeft: function (t) {
            try {
                var e = document.getElementsByClassName("leaflet-sidebar-left")[0];
                if (t) {
                    spinner.stop();
        ...
        _toggleControlsSidebarRight: function (t) {
            try {

                var e = document.getElementsByClassName("leaflet-sidebar-right")[0];
            if (t) return e.style.display = "block";
            e.style.display = "none"
            }catch (e) {
